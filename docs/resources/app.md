...
- `locked` (Boolean) Whether the application is locked for deployment. When true, a deploy lock is placed on the app (dokku apps:lock) and deploys are blocked until it is unlocked.
