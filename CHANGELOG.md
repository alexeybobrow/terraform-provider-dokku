...
### Fixed
* Surface errors that were previously ignored during app updates (config unset, buildpack and nginx changes), when reading app config, and when creating a service link, so failures are reported instead of silently succeeding## v0.6.0 - 2026-06-22
### Changed
